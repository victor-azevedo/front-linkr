  ...
  return (
    <Page>
      ...
      <TimelineStyle>
        <h2>timeline</h2>
        <Cards>
          <PostLinkr pictureUrl={pictureUrl} />
          <LinkCard pictureUrl={pictureUrl} />
          <LinkCard pictureUrl={pictureUrl} />
          <LinkCard pictureUrl={pictureUrl} />
          <LinkCard pictureUrl={pictureUrl} />
        </Cards>
